...
*** free is most expensive (see [[Predictably Irrational]] )
*** coupons
** Promotions
*** coupons that can't be fulfilled (e.g. having pre-conditions like you can use the coupon only if you have spent more than $1000, you can use only one in one purchase)
