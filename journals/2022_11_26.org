...
The normal page table is created per process. When the operating system is doing context switch, it also changes the register in x86 (level 0 of the page table)