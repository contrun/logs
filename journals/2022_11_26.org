...
Let \( (U, V, W) \) be the cipher text, noting that \( e(r Q_{\text{id}}, P_{\text{pub}}) = e(r Q_{\text{id}}, s P) = e(s Q_{\text{id}}, r P) = e(s_{\text{id}}, rP) \), let \( \psi = H_2(e(s_{\text{id}}, U)) \oplus V \), let \( M = W \oplus H_4(\psi) \), if \( U = H_3(\psi, M)P \) is the clear text.
*