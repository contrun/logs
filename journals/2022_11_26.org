...
Let \( (U, V) \) be the cipher text, noting that \( e(r Q_{\text{id}}, P_{\text{pub}}) = e(r Q_{\text{id}}, s P) = e(s Q_{\text{id}}, r P) \), we can see \( H(e(s_{\text{id}}, U)) \oplus V \) is the clear text.
