...
* How does reverse map table distinguish guests, nested guests? It must need helps from the operating system and hypervisor. Is there a new instruction? What kind of information