...
By the equation \( s = k^{-1}(z + ra) \), we can see that \( a = r^{-1}(z - ks) \). Note this equation is actually a modular equation, i.e.  \( a \equiv r^{-1}(z - ks) \operatorname{mod} n \). This does not tr
*
*