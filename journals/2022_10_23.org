...
Must we hack the grammar to avoid ambiguity first? Can we do such thing?
This is called reduce/reduce conflict and shift/reduce conflict in the 6.035 slides.
