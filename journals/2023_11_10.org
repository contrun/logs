...
It seems that this means when peers tends to connect more peers with the shorter distance. But the peer ID are uniformly distributed in the ID space. How can
