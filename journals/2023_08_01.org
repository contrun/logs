...
This is because the characteristic of secp256k1 field (let it be \(p\)) minus the order of the group is too small (see [[https://github.com/bitcoin-core/secp256k1/blob/26392da2fb7153addae0bd604495eb96f995d76c/src/modules/recovery/main_impl.h#L148-L148][secp256k1/src/modules/recovery/main_impl.h at 26392da2fb7153addae0bd604495eb96f995d76c · bitcoin-core/secp256k1]]). There is only two possibility of the x coordinate (let it be \( P_x\)) of a point (let it be \(P\)) on secp256k1, that is, \( P_x = 
m + n * i\), where \( 0 \leq m \le n \) and \( i \in \{0, 1\} \).