...
* How are \( z_1, \dots, z_n\) chosen in the polynomial commitment scheme given in the plonk paper p11. Are they randomly chosen fixed constants? What's the use of these things? For blinding?